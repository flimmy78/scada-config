...
public class ProjectInitWindow extends ApplicationWindow {
	...
	private void initDataBase() {
		...
		EndTagType endTagType12  = new EndTagType(EndTagTypeEnum.LIAN_HE_ZHAN_SUB.toString(), EndTagTypeEnum.LIAN_HE_ZHAN_SUB.getValue());
		...
		endTagTypeList.add(endTagType12);
		...
		VarGroupCfg varGroupCfgJiLiangZhan = new VarGroupCfg(VarGroupEnum.JI_LIANG_ZHAN.toString(), VarGroupEnum.JI_LIANG_ZHAN.getValue());
		VarGroupCfg varGroupCfgYaoKong = new VarGroupCfg(VarGroupEnum.YAO_KONG.toString(), VarGroupEnum.YAO_KONG.getValue());
		...
		// 以下是通用个个性分组
		VarGroupCfg varGroupCfgTongYongGX1 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX1.toString(), VarGroupEnum.TONG_YONG_GX1.getValue());
		VarGroupCfg varGroupCfgTongYongGX2 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX2.toString(), VarGroupEnum.TONG_YONG_GX2.getValue());
		VarGroupCfg varGroupCfgTongYongGX3 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX3.toString(), VarGroupEnum.TONG_YONG_GX3.getValue());
		VarGroupCfg varGroupCfgTongYongGX4 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX4.toString(), VarGroupEnum.TONG_YONG_GX4.getValue());
		VarGroupCfg varGroupCfgTongYongGX5 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX5.toString(), VarGroupEnum.TONG_YONG_GX5.getValue());
		VarGroupCfg varGroupCfgTongYongGX6 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX6.toString(), VarGroupEnum.TONG_YONG_GX6.getValue());
		VarGroupCfg varGroupCfgTongYongGX7 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX7.toString(), VarGroupEnum.TONG_YONG_GX7.getValue());
		VarGroupCfg varGroupCfgTongYongGX8 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX8.toString(), VarGroupEnum.TONG_YONG_GX8.getValue());
		VarGroupCfg varGroupCfgTongYongGX9 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX9.toString(), VarGroupEnum.TONG_YONG_GX9.getValue());
		VarGroupCfg varGroupCfgTongYongGX10 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX10.toString(), VarGroupEnum.TONG_YONG_GX10.getValue());
		VarGroupCfg varGroupCfgTongYongGX11 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX11.toString(), VarGroupEnum.TONG_YONG_GX11.getValue());
		VarGroupCfg varGroupCfgTongYongGX12 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX12.toString(), VarGroupEnum.TONG_YONG_GX12.getValue());
		VarGroupCfg varGroupCfgTongYongGX13 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX13.toString(), VarGroupEnum.TONG_YONG_GX13.getValue());
		VarGroupCfg varGroupCfgTongYongGX14 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX14.toString(), VarGroupEnum.TONG_YONG_GX14.getValue());
		VarGroupCfg varGroupCfgTongYongGX15 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX15.toString(), VarGroupEnum.TONG_YONG_GX15.getValue());
		VarGroupCfg varGroupCfgTongYongGX16 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX16.toString(), VarGroupEnum.TONG_YONG_GX16.getValue());
		VarGroupCfg varGroupCfgTongYongGX17 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX17.toString(), VarGroupEnum.TONG_YONG_GX17.getValue());
		VarGroupCfg varGroupCfgTongYongGX18 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX18.toString(), VarGroupEnum.TONG_YONG_GX18.getValue());
		VarGroupCfg varGroupCfgTongYongGX19 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX19.toString(), VarGroupEnum.TONG_YONG_GX19.getValue());
		VarGroupCfg varGroupCfgTongYongGX20 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX20.toString(), VarGroupEnum.TONG_YONG_GX20.getValue());
		VarGroupCfg varGroupCfgTongYongGX21 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX21.toString(), VarGroupEnum.TONG_YONG_GX21.getValue());
		VarGroupCfg varGroupCfgTongYongGX22 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX22.toString(), VarGroupEnum.TONG_YONG_GX22.getValue());
		VarGroupCfg varGroupCfgTongYongGX23 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX23.toString(), VarGroupEnum.TONG_YONG_GX23.getValue());
		VarGroupCfg varGroupCfgTongYongGX24 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX24.toString(), VarGroupEnum.TONG_YONG_GX24.getValue());
		VarGroupCfg varGroupCfgTongYongGX25 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX25.toString(), VarGroupEnum.TONG_YONG_GX25.getValue());
		VarGroupCfg varGroupCfgTongYongGX26 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX26.toString(), VarGroupEnum.TONG_YONG_GX26.getValue());
		VarGroupCfg varGroupCfgTongYongGX27 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX27.toString(), VarGroupEnum.TONG_YONG_GX27.getValue());
		VarGroupCfg varGroupCfgTongYongGX28 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX28.toString(), VarGroupEnum.TONG_YONG_GX28.getValue());
		VarGroupCfg varGroupCfgTongYongGX29 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX29.toString(), VarGroupEnum.TONG_YONG_GX29.getValue());
		VarGroupCfg varGroupCfgTongYongGX30 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX30.toString(), VarGroupEnum.TONG_YONG_GX30.getValue());
		VarGroupCfg varGroupCfgTongYongGX31 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX31.toString(), VarGroupEnum.TONG_YONG_GX31.getValue());
		VarGroupCfg varGroupCfgTongYongGX32 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX32.toString(), VarGroupEnum.TONG_YONG_GX32.getValue());
		VarGroupCfg varGroupCfgTongYongGX33 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX33.toString(), VarGroupEnum.TONG_YONG_GX33.getValue());
		VarGroupCfg varGroupCfgTongYongGX34 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX34.toString(), VarGroupEnum.TONG_YONG_GX34.getValue());
		VarGroupCfg varGroupCfgTongYongGX35 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX35.toString(), VarGroupEnum.TONG_YONG_GX35.getValue());
		VarGroupCfg varGroupCfgTongYongGX36 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX36.toString(), VarGroupEnum.TONG_YONG_GX36.getValue());
		VarGroupCfg varGroupCfgTongYongGX37 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX37.toString(), VarGroupEnum.TONG_YONG_GX37.getValue());
		VarGroupCfg varGroupCfgTongYongGX38 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX38.toString(), VarGroupEnum.TONG_YONG_GX38.getValue());
		VarGroupCfg varGroupCfgTongYongGX39 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX39.toString(), VarGroupEnum.TONG_YONG_GX39.getValue());
		VarGroupCfg varGroupCfgTongYongGX40 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX40.toString(), VarGroupEnum.TONG_YONG_GX40.getValue());
		VarGroupCfg varGroupCfgTongYongGX41 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX41.toString(), VarGroupEnum.TONG_YONG_GX41.getValue());
		VarGroupCfg varGroupCfgTongYongGX42 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX42.toString(), VarGroupEnum.TONG_YONG_GX42.getValue());
		VarGroupCfg varGroupCfgTongYongGX43 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX43.toString(), VarGroupEnum.TONG_YONG_GX43.getValue());
		VarGroupCfg varGroupCfgTongYongGX44 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX44.toString(), VarGroupEnum.TONG_YONG_GX44.getValue());
		VarGroupCfg varGroupCfgTongYongGX45 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX45.toString(), VarGroupEnum.TONG_YONG_GX45.getValue());
		VarGroupCfg varGroupCfgTongYongGX46 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX46.toString(), VarGroupEnum.TONG_YONG_GX46.getValue());
		VarGroupCfg varGroupCfgTongYongGX47 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX47.toString(), VarGroupEnum.TONG_YONG_GX47.getValue());
		VarGroupCfg varGroupCfgTongYongGX48 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX48.toString(), VarGroupEnum.TONG_YONG_GX48.getValue());
		VarGroupCfg varGroupCfgTongYongGX49 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX49.toString(), VarGroupEnum.TONG_YONG_GX49.getValue());
		VarGroupCfg varGroupCfgTongYongGX50 = new VarGroupCfg(VarGroupEnum.TONG_YONG_GX50.toString(), VarGroupEnum.TONG_YONG_GX50.getValue());
		...
		varGroupCfgList.add(varGroupCfgJiLiangZhan);
		varGroupCfgList.add(varGroupCfgYaoKong);
		varGroupCfgList.add(varGroupCfgYaoTiaoYouJing);
		varGroupCfgList.add(varGroupCfgYaoTiaoCGQ);
		varGroupCfgList.add(varGroupCfgQT);
		// 50个通用个性模板
		varGroupCfgList.add(varGroupCfgTongYongGX1);
		varGroupCfgList.add(varGroupCfgTongYongGX2);
		varGroupCfgList.add(varGroupCfgTongYongGX3);
		varGroupCfgList.add(varGroupCfgTongYongGX4);
		varGroupCfgList.add(varGroupCfgTongYongGX5);
		varGroupCfgList.add(varGroupCfgTongYongGX6);
		varGroupCfgList.add(varGroupCfgTongYongGX7);
		varGroupCfgList.add(varGroupCfgTongYongGX8);
		varGroupCfgList.add(varGroupCfgTongYongGX9);
		varGroupCfgList.add(varGroupCfgTongYongGX10);
		varGroupCfgList.add(varGroupCfgTongYongGX11);
		varGroupCfgList.add(varGroupCfgTongYongGX12);
		varGroupCfgList.add(varGroupCfgTongYongGX13);
		varGroupCfgList.add(varGroupCfgTongYongGX14);
		varGroupCfgList.add(varGroupCfgTongYongGX15);
		varGroupCfgList.add(varGroupCfgTongYongGX16);
		varGroupCfgList.add(varGroupCfgTongYongGX17);
		varGroupCfgList.add(varGroupCfgTongYongGX18);
		varGroupCfgList.add(varGroupCfgTongYongGX19);
		varGroupCfgList.add(varGroupCfgTongYongGX20);
		varGroupCfgList.add(varGroupCfgTongYongGX21);
		varGroupCfgList.add(varGroupCfgTongYongGX22);
		varGroupCfgList.add(varGroupCfgTongYongGX23);
		varGroupCfgList.add(varGroupCfgTongYongGX24);
		varGroupCfgList.add(varGroupCfgTongYongGX25);
		varGroupCfgList.add(varGroupCfgTongYongGX26);
		varGroupCfgList.add(varGroupCfgTongYongGX27);
		varGroupCfgList.add(varGroupCfgTongYongGX28);
		varGroupCfgList.add(varGroupCfgTongYongGX29);
		varGroupCfgList.add(varGroupCfgTongYongGX30);
		varGroupCfgList.add(varGroupCfgTongYongGX31);
		varGroupCfgList.add(varGroupCfgTongYongGX32);
		varGroupCfgList.add(varGroupCfgTongYongGX33);
		varGroupCfgList.add(varGroupCfgTongYongGX34);
		varGroupCfgList.add(varGroupCfgTongYongGX35);
		varGroupCfgList.add(varGroupCfgTongYongGX36);
		varGroupCfgList.add(varGroupCfgTongYongGX37);
		varGroupCfgList.add(varGroupCfgTongYongGX38);
		varGroupCfgList.add(varGroupCfgTongYongGX39);
		varGroupCfgList.add(varGroupCfgTongYongGX40);
		varGroupCfgList.add(varGroupCfgTongYongGX41);
		varGroupCfgList.add(varGroupCfgTongYongGX42);
		varGroupCfgList.add(varGroupCfgTongYongGX43);
		varGroupCfgList.add(varGroupCfgTongYongGX44);
		varGroupCfgList.add(varGroupCfgTongYongGX45);
		varGroupCfgList.add(varGroupCfgTongYongGX46);
		varGroupCfgList.add(varGroupCfgTongYongGX47);
		varGroupCfgList.add(varGroupCfgTongYongGX48);
		varGroupCfgList.add(varGroupCfgTongYongGX49);
		varGroupCfgList.add(varGroupCfgTongYongGX50);
		...
		varGroupCfgSet.add(varGroupCfgYaoKong);
		...
		// 50 个通用个性分组
		varGroupCfgSet.add(varGroupCfgTongYongGX1);	
		varGroupCfgSet.add(varGroupCfgTongYongGX2);	
		varGroupCfgSet.add(varGroupCfgTongYongGX3);	
		varGroupCfgSet.add(varGroupCfgTongYongGX4);	
		varGroupCfgSet.add(varGroupCfgTongYongGX5);	
		varGroupCfgSet.add(varGroupCfgTongYongGX6);	
		varGroupCfgSet.add(varGroupCfgTongYongGX7);	
		varGroupCfgSet.add(varGroupCfgTongYongGX8);	
		varGroupCfgSet.add(varGroupCfgTongYongGX9);	
		varGroupCfgSet.add(varGroupCfgTongYongGX10);	
		varGroupCfgSet.add(varGroupCfgTongYongGX11);	
		varGroupCfgSet.add(varGroupCfgTongYongGX12);	
		varGroupCfgSet.add(varGroupCfgTongYongGX13);	
		varGroupCfgSet.add(varGroupCfgTongYongGX14);	
		varGroupCfgSet.add(varGroupCfgTongYongGX15);	
		varGroupCfgSet.add(varGroupCfgTongYongGX16);	
		varGroupCfgSet.add(varGroupCfgTongYongGX17);	
		varGroupCfgSet.add(varGroupCfgTongYongGX18);	
		varGroupCfgSet.add(varGroupCfgTongYongGX19);	
		varGroupCfgSet.add(varGroupCfgTongYongGX20);
		varGroupCfgSet.add(varGroupCfgTongYongGX21);	
		varGroupCfgSet.add(varGroupCfgTongYongGX22);	
		varGroupCfgSet.add(varGroupCfgTongYongGX23);	
		varGroupCfgSet.add(varGroupCfgTongYongGX24);	
		varGroupCfgSet.add(varGroupCfgTongYongGX25);	
		varGroupCfgSet.add(varGroupCfgTongYongGX26);	
		varGroupCfgSet.add(varGroupCfgTongYongGX27);	
		varGroupCfgSet.add(varGroupCfgTongYongGX28);	
		varGroupCfgSet.add(varGroupCfgTongYongGX29);	
		varGroupCfgSet.add(varGroupCfgTongYongGX30);
		varGroupCfgSet.add(varGroupCfgTongYongGX31);	
		varGroupCfgSet.add(varGroupCfgTongYongGX32);	
		varGroupCfgSet.add(varGroupCfgTongYongGX33);	
		varGroupCfgSet.add(varGroupCfgTongYongGX34);	
		varGroupCfgSet.add(varGroupCfgTongYongGX35);	
		varGroupCfgSet.add(varGroupCfgTongYongGX36);	
		varGroupCfgSet.add(varGroupCfgTongYongGX37);	
		varGroupCfgSet.add(varGroupCfgTongYongGX38);	
		varGroupCfgSet.add(varGroupCfgTongYongGX39);	
		varGroupCfgSet.add(varGroupCfgTongYongGX40);
		varGroupCfgSet.add(varGroupCfgTongYongGX41);	
		varGroupCfgSet.add(varGroupCfgTongYongGX42);	
		varGroupCfgSet.add(varGroupCfgTongYongGX43);	
		varGroupCfgSet.add(varGroupCfgTongYongGX44);	
		varGroupCfgSet.add(varGroupCfgTongYongGX45);	
		varGroupCfgSet.add(varGroupCfgTongYongGX46);	
		varGroupCfgSet.add(varGroupCfgTongYongGX47);	
		varGroupCfgSet.add(varGroupCfgTongYongGX48);	
		varGroupCfgSet.add(varGroupCfgTongYongGX49);	
		varGroupCfgSet.add(varGroupCfgTongYongGX50);	
