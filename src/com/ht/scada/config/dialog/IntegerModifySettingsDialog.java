...
public class IntegerModifySettingsDialog extends Dialog {

	private IntegerModifyTypeModel model;
	private Text text;
	 ...
	 * @param parentShell
	 */
	public IntegerModifySettingsDialog(Shell parentShell, IntegerModifyTypeModel model, int num) {
		super(parentShell);
		this.model = model;
		this.num = num;
	}
	...
	private void initValues() {
		text_base.setText(Integer.toString(this.model.getBase()));
